(function (exports) {
	...
	const Product = product => {
	  ...
	  return /*#__PURE__*/React.createElement("tr", null, /*#__PURE__*/React.createElement("td", null, name), /*#__PURE__*/React.createElement("td", {
	    className: "prices"
	...
	const ProductsBody = ({
	  ...
	  return /*#__PURE__*/React.createElement("tbody", null, products.length === 0 ? 'No products yet.' : products.map(product => /*#__PURE__*/React.createElement(Product, {
	    key: product.id,
	    name: product.name,
	    price: product.price,
	    id: product.id,
	...
	exports.ProductsBody = ProductsBody;
